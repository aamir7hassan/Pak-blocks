				...
				<div class="panel-body">
					<form role="form" method="post" action="<?=base_url('admin/dashboard/process_product')?>" data-parsley-validate="true" enctype="multipart/form-data" novalidate>
						...
						<!--<div class="form-group">
							...
							<input type="text" data-parsley-required="true" data-parsley-required-message="Enter first name" class="form-control" name="name" id="name" value="<?=set_value('name')?>" />
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text"  class="form-control" name="length" id="length" value="<?=set_value('length')?>" />
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="height" id="height" value="<?=set_value('height')?>" />
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="width" id="width" value="<?=set_value('width')?>" />
